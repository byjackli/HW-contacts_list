...
function Editor(props) {
    ...
    return <div className="editor" >
        <form onSubmit={e => e.preventDefault()}>
            ...
            <input name="phoneNumber" type="tel" placeholder="Phone Number" value={formData.phoneNumber} onChange={handleUpdateField} />
            <input name="emailAddress" type="email" placeholder="Email Address" value={formData.emailAddress} onChange={handleUpdateField} />
        </form >
